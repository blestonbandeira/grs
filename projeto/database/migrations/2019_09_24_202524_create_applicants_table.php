...
class CreateApplicantsTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('applicants', function (Blueprint $table) {
            ...
            $table->boolean('appForm')->default(false);
            $table->boolean('cc')->default(false);
            $table->boolean('diploma')->default(false);
            $table->boolean('unemployementUrl')->default(false);
            $table->boolean('curriculum')->default(false);
            $table->boolean('criminalRecord')->default(false);
            $table->boolean('medicalRecord')->default(false);
            $table->boolean('dataAssessment')->default(false);
