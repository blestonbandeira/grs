...
class CreateApplicantsTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('applicants', function (Blueprint $table) {
            ...
            $table->boolean('unemployementUrl')->nullable()->default(false);
            $table->boolean('curriculum')->nullable()->default(false);
            $table->boolean('criminalRecord')->nullable()->default(false);
            $table->boolean('medicalRecord')->nullable()->default(false);
            $table->boolean('dataAssessment')->nullable()->default(false);
            $table->boolean('apt')->nullable()->default(false);        
