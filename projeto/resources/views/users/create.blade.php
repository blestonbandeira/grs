            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    <div class="accordion" id="users">
                        <div class="card">
                            <div class="card-header card-header-info" data-toggle="collapse" data-target="#usersCreate"
                                aria-expanded="true" aria-controls="usersCreate">
                            ...
                            <div class="card-body">
                                ...
                                <div class="row justify-content-md-center">
                                    ...
                                    <div class="col-md-3">
                                        <br />
                                        <label class="border-top-0 border-left-0 border-right-0" name="name">Nome do
                                            Curso</label>
                                        <select name="permission_level_id" class="custom-select input-border-width">
                                            @if (count($permissionLevels) > 0 )
                                            <option disabled>-- selecione aqui o nível de acesso--</option>
